# Dictionary for sms — mul

This repository contains source files for a dictionary from Skolt Saami to Multiple languages. The content is licensed under the  license.

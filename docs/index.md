# The Skolt Sámi dictionary

This page documents the Skolt Saami dictionary projects at
Giellatekno, as it was conducted in 2015. Part of the documentation
may thus be obsolete.

The backbone of all dictionary projects, incl. the contlex files for
the morphological analyzer, the Skolt Saami Oahpa and different user
dictionaries are the lexical data stored in a database called sms2X.
...
Giellatekno, and members of the Skolt Saami language communities.
